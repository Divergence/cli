...
class Basics
{
    ...
    public static function usage()
    {
        ...
        $climate->out('');
        $climate->out("\ttest database\t\tChecks if database configuration works by trying to connect to it. Asks you to choose a label name or provide one as the next argument.");
    }
}
